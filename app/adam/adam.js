...
var adamService_1 = require('./adamService');
var Adam = (function () {
    function Adam(adamService) {
        this.adamService = adamService;
        this.mode = 'Observable';
        console.info('Adam constructor');
    }
    Adam.prototype.ngOnInit = function () {
    ...
    Adam = __decorate([
        core_1.Component({
            ...
            providers: [adamService_1.AdamService]
        }), 
        __metadata('design:paramtypes', [adamService_1.AdamService])
    ], Adam);
    return Adam;
}());
exports.Adam = Adam;
